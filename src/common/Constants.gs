var APP_CONSTANTS = Object.freeze({
  ...
  CONFIG_DEFAULTS: Object.freeze([
    ...
    { key: 'PROACTIVE_RECHECK_MINUTES', value: '60', type: 'int', description: 'Deterministic proactive decision-sample slot duration' },
    { key: 'PROACTIVE_POLICY_MODE', value: 'probability', type: 'string', description: 'Proactive policy mode: threshold or probability' },
  ...
  SHEET_SCHEMAS: Object.freeze({
    ...
    daily_summaries: [
      ...
      { name: 'created_at', type: 'datetime', required: true },
      { name: 'updated_at', type: 'datetime', required: true },
      { name: 'diary_payload_json', type: 'json', required: false },
      { name: 'diary_approval_json', type: 'json', required: false },
      { name: 'diary_origin_event_id', type: 'string', required: false }
    ],
    usage_daily: [
