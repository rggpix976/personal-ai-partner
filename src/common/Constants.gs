var APP_CONSTANTS = Object.freeze({
  ...
  CHARACTER: Object.freeze({
    PROFILE_SCHEMA_VERSION: 'character-profile.v1',
    CONTEXT_SCHEMA_VERSION: 'character-context.v1',
    POLICY_VERSION: 'character-policy.v1',
    CATALOG_VERSION: 'character-catalog.v1',
    MAX_PROFILE_BYTES: 4096,
    RUNTIME_MODES: Object.freeze(['legacy', 'enforced']),
    PROFILE_MODES: Object.freeze(['legacy', 'v1']),
    SPEECH_PRESETS: Object.freeze(['natural', 'polite', 'calm', 'cheerful', 'playful']),
    WARMTH_LEVELS: Object.freeze(['reserved', 'balanced', 'sweet']),
    ...
    DEFAULT_PROFILE_JSON: '{"schemaVersion":"character-profile.v1","identity":{"partnerName":"Partner","firstPerson":"私","userAddress":"あなた"},"style":{"speechPreset":"natural","warmth":"balanced","replyLength":"balanced"},"flavor":{"note":"","exampleLines":[]}}'
  }),
  ...
  CONFIG_DEFAULTS: Object.freeze([
    ...
    { key: 'CHARACTER_PROFILE_MODE', value: 'legacy', type: 'string', description: 'Character profile mode: legacy or v1' },
    ...
    { key: 'CHARACTER_PROFILE_REVISION', value: '0', type: 'int', description: 'System-managed character profile revision' },
