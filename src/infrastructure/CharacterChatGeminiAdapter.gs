var CharacterChatGeminiAdapter = (function() {
  ...
  function buildGenerationRequest_(context, surface, mode, rewriteCategory, preparedImage) {
    ...
    var systemInstruction = [
      ...
      'Approved Partner World continuity may be spoken naturally from inside the character viewpoint without calling it fictional, artificial, generated, or a setting. Do not expand it into a new event on this surface.',
      taskInstruction,
      outputInstruction,
