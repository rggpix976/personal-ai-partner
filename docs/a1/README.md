...
矛盾または不足がある場合は `templates/CHANGE_REQUEST.md` を提出し、独断で契約を変更しない。
...
- 変更申請は `templates/CHANGE_REQUEST.md` を使う。
- 成果物は `templates/HANDOFF_REPORT.md` の形式を満たす。
- テストのない実装は受領しない。
